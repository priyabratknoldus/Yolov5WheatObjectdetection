...
def run(weights='best.pt',  # model.pt path(s)
        ...
        source='static/inputImage.jpg',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='static/inputImage.jpg', help='file/dir/URL/glob, 0 for webcam')
...
if __name__ == "__main__":
    opt = parse_opt()
    damaged=main(opt)
    print(damaged+"print damaged wheat grains")
